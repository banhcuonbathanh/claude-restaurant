...
- Name: staff-internal-reactions.spec.ts >> Permission Matrix — role access guards >> chef is blocked from /admin/products
- Location: tests/staff-internal-reactions.spec.ts:695:7
...
Expected pattern: not /\/admin\/products/
Received string: "http://localhost:3000/admin/products"
Timeout: 8000ms

Call log:
  - Expect "not toHaveURL" with timeout 8000ms
    20 × unexpected value "http://localhost:3000/admin/products"
