...
- Name: staff-internal-reactions.spec.ts >> C — Table & QR Code Management >> C2 — QR code is visible for each table
- Location: tests/staff-internal-reactions.spec.ts:442:7
