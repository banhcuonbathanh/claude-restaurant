...
SELECT id, order_number, table_id, source, customer_name, customer_phone, note, total_amount, created_by, created_at, updated_at, deleted_at, group_id, status, delivery_address, pickup_at FROM orders
WHERE table_id = ?
