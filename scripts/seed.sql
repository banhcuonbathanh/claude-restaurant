...
VALUES
  ...
  ('22222222-2222-2222-2222-000000000006', 'Bàn 06',
   'f67890123456789af67890123456789af67890123456789af67890123456789a',
   4, 'available', 1, NOW(), NOW()),

  ('22222222-2222-2222-2222-000000000007', 'Bàn 07',
   '0707070707070707070707070707070707070707070707070707070707070707',
   4, 'available', 1, NOW(), NOW()),

  ('22222222-2222-2222-2222-000000000008', 'Bàn 08',
   '0808080808080808080808080808080808080808080808080808080808080808',
   4, 'available', 1, NOW(), NOW()),

  ('22222222-2222-2222-2222-000000000009', 'Bàn 09',
  ...
  ('22222222-2222-2222-2222-000000000010', 'Bàn 10',
   ...
   4, 'available', 1, NOW(), NOW())
ON DUPLICATE KEY UPDATE name = VALUES(name), capacity = VALUES(capacity), status = VALUES(status), updated_at = NOW();
